...
From the above table I made, it shows that the proportion of ethnicity in those three groups of thirty_day_mort.
As we can see that the value of proportion has similar pattern within each group. I believe that if we conduct 
a proportion test, its p value should be >= .05 which means that those three group should have same pattern in ethnicity.
...
From the above table I made, it shows that the proportion of insurance in those three groups of thirty_day_mort.
As we can see that the value of patient who died within 30 days of hospital admission have higher proportion on 
choosing Medicaid (12.2%) compare to other two groups.
...
From the above table I made, it shows that the proportion of marital_status in those three groups of thirty_day_mort.
As we can see that the value of patient who died after 30 days of hospital admission (thirty_day_mort = 0) have different pattern compare to other two groups, which included higher proportion on WIDOWED, NA and lower proportion on SINGLE and MARRIED.
...
From the above table I made, it shows that the proportion of gender in those three groups of thirty_day_mort.
As we can see that the value of proportion has similar pattern within each group. I believe that if we conduct 
a proportion test, its p value should be >= .05 which means that those three group should have same pattern in gender
...
mimic_icu_cohort %>%
         ...
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$age_hadm,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of age at hospital admission in those three groups of thirty_day_mort.
Although we can see that the value of age at hospital admission of patient who died after 30 days of hospital admission
(thirty_day_mort = 0) have higher mean, I believe that they still have similar pattern within each group.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$bicarbonate,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on bicarbonate in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on bicarbonate of patient who died within 30 days of 
hospital admission (thirty_day_mort = 1) have higher mean, Q1, and Q3.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$calcium,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on calcium in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on calcium of patient who died after 30 days of 
hospital admission (thirty_day_mort = 0) have higher mean.
...
mimic_icu_cohort %>%
         ...
         facet_wrap( ~ thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$chloride,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on chloride in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on chloride of patient who died after 30 days of 
hospital admission (thirty_day_mort = 0) have same mean, Q1 and Q3 as thirty_day_mort = 1.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="fixed") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$creatinine,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on creatinine in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on creatinine of patient who don't died 
(thirty_day_mort = NA) have lowest mean, Q1 and Q3 compare to thirty_day_mort = 0 and 1.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$glucose,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on glucose in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on glucose of patient who don't died 
(thirty_day_mort = NA) have lowest mean, Q1 and Q3 compare to thirty_day_mort = 0 and 1.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$magnesium,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on magnesium in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on magnesium of patient who don't died 
(thirty_day_mort = NA) have same pattern compare to thirty_day_mort = 0 and 1.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$potassium,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on potassium in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on potassium of patient who don't died 
(thirty_day_mort = NA) have same pattern compare to thirty_day_mort = 0 and 1.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$sodium,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on sodium in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on sodium of patient who don't died 
(thirty_day_mort = NA) have same pattern compare to thirty_day_mort = 0 and 1.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$hematocrit,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on hematocrit in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on hematocrit of patient who died within 30 days of 
hospital admission (thirty_day_mort = 1) have lower mean, Q1, and Q3.
...
mimic_icu_cohort %>%
         ...
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$WBC_count,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first lab measurements on WBC_count in those three groups of 
thirty_day_mort. We can see that the value of first lab measurements on WBC_count of patient who died after 30 days of 
hospital admission (thirty_day_mort = 0) have higher mean, Q1, and Q3.
...
#heart_rate
mimic_icu_cohort %>%
         ggplot(mapping = aes(x = " ", y = heart_rate)) + 
         geom_boxplot(color = "burlywood2", outlier.shape = NA) +
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                         quantile(mimic_icu_cohort$heart_rate,
                                  c(0.05, 0.95),
                                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first vital measurements on heart_rate in those three groups of 
thirty_day_mort. We can see that the value of first vital measurements on heart_rate of patient who died within 30 days of 
hospital admission (thirty_day_mort = 1) have higher mean, Q1, and Q3.

```{r, echo=TRUE}
#mean_non_invasive_blood_pressure
mimic_icu_cohort %>%
         ggplot(mapping = aes(x = " ", y = mean_non_invasive_blood_pressure)) + 
         geom_boxplot(color = "mediumpurple1", outlier.shape = NA) +
         facet_wrap( ~ thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
         quantile(mimic_icu_cohort$mean_non_invasive_blood_pressure,
                  c(0.05, 0.95),
                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first vital measurements on mean_non_invasive_blood_pressure in those
three groups of thirty_day_mort. We can see that the value of first vital measurements on mean_non_invasive_blood_pressure of
patient who died within 30 days of hospital admission (thirty_day_mort = 1) have lower mean, Q1, and Q3.

```{r, echo=TRUE}
#systolic_non_invasive_blood_pressure
mimic_icu_cohort %>%
         ggplot(mapping = aes(x = " ", y = systolic_non_invasive_blood_pressure)) + 
         geom_boxplot(color = "brown1", outlier.shape = NA) +
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
         quantile(mimic_icu_cohort$systolic_non_invasive_blood_pressure,
                  c(0.05, 0.95),
                  na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first vital measurements on systolic_non_invasive_blood_pressure in 
those three groups of thirty_day_mort. We can see that the value of first vital measurements on 
systolic_non_invasive_blood_pressure of patient who died within 30 days of hospital admission (thirty_day_mort = 1) have lower 
mean, Q1, and Q3.

```{r, echo=TRUE}
#body_temperture
mimic_icu_cohort %>%
         ggplot(mapping = aes(x = " ", y = body_temperature)) + 
         geom_boxplot(color = "navy blue", outlier.shape = NA) +
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                          quantile(mimic_icu_cohort$body_temperature,
                                   c(0.05, 0.95),
                                   na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first vital measurements on body_temperture in those three groups of 
thirty_day_mort. We can see that the value of first vital measurements on body_temperture of patient who don't died 
(thirty_day_mort = NA) have same pattern compare to thirty_day_mort = 0 and 1.

```{r, echo=TRUE}
#respiratory_rate
mimic_icu_cohort %>%
         ggplot(mapping = aes(x = " ", y = respiratory_rate)) + 
         geom_boxplot(color = "green", outlier.shape = NA) +
         facet_wrap(~thirty_day_mort, scale="free") +
         coord_cartesian(ylim = 
                          quantile(mimic_icu_cohort$respiratory_rate,
                                   c(0.05, 0.95),
                                   na.rm = T))
```
...
From the graphic I made above, it shows that the boxplot of first vital measurements on respiratory_rate in those three groups of
thirty_day_mort. We can see that the value of first vital measurements on respiratory_rate of patient who don't died 
(thirty_day_mort = NA) have lower mean, Q1 and Q3 compare to thirty_day_mort = 0 and 1.
...
mimic_icu_cohort %>% 
  ...
  rowwise() %>% 
  mutate(total = sum(c_across("Cardiac Vascular Intensive Care Unit (CVICU)":
                                "Trauma SICU (TSICU)"),
                 na.rm = T)) %>% 
  mutate_at(vars("Cardiac Vascular Intensive Care Unit (CVICU)":
                   "Trauma SICU (TSICU)"),
            funs(round(./ total, digits = 3)*100)) %>% 
  print(width = Inf)
```
...
From the above table I made, it shows that the proportion of first_careunit in those three groups of thirty_day_mort.
