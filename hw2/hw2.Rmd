...
From the table I made below, it shows that the proportion of ethnicity in those three groups of thirty_day_mort.
...
From the table I made below, it shows that the proportion of insurance in those three groups of thirty_day_mort.
...
From the table I made below, it shows that the proportion of marital_status in those three groups of thirty_day_mort.
As we can see that the value of patient who died after 30 days of hospital admission (thirty_day_mort = 0) have different pattern compare to other two 
groups, which included higher proportion on WIDOWED, NA and lower proportion on SINGLE and MARRIED.
...
From the table I made below, it shows that the proportion of gender in those three groups of thirty_day_mort.
As we can see that the value of proportion has similar pattern within each group. I believe that if we conduct 
...
From the graphic I made below, it shows that the boxplot of age at hospital admission in those three groups of thirty_day_mort.
...
From the graphic I made below, it shows that the boxplot of first lab measurements on bicarbonate in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on calcium in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on chloride in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on creatinine in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on glucose in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on magnesium in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on potassium in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on sodium in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on hematocrit in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first lab measurements on WBC_count in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first vital measurements on heart_rate in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first vital measurements on mean_non_invasive_blood_pressure in those
...
From the graphic I made below, it shows that the boxplot of first vital measurements on systolic_non_invasive_blood_pressure in 
...
From the graphic I made below, it shows that the boxplot of first vital measurements on body_temperture in those three groups of 
...
From the graphic I made below, it shows that the boxplot of first vital measurements on respiratory_rate in those three groups of
